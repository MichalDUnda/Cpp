...
// dynamically add behavior to a class without making changes to that class.
// In other words, it uses composition instead of inheritance to add the functionality of an object.
...
// this is dynamic decorator.
// we extend shape functionality

// downside
// ColoredShape do not have acces to particular shape object
// e.g.
// Circle circle{};
// ColoredShape coloredShape{circle, "red"};
// not possible to call resize on coloredShape.
...
// possibility to call underline functionality

void dynamicDecoratorMainFunc()
{
    Circle circle{5};
...
// function decorator
// add behaviour round the function invocation
struct Logger
{
    function<void()> func;
    string name;
